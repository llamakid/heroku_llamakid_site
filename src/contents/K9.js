...
import K9SiteImage from '../images/k9Site-small.gif';
            ...
            <div className="work__box">
                <div className="work__text">
                    ...
                    <div className="work__links">
                        <a href="https://www.dummydomain.us" target="_blank" rel="noreferrer noopener"  className="link__text">
                            Visit Site <span>&rarr;</span>
                        </a>
                        <a href="https://www.dummydomain.us" title="View Source Code" target="_blank" rel="noreferrer noopener">
                            <img src={K9SiteImage} className="work__code" alt="GitHub" />
                        </a>
                    </div>
                        
                </div>
                <div class="work__image-box">
                        <img src={K9SiteImage} className="work__image" alt="Project 1" />
                </div>
            </div>
        )
    }
